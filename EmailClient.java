...
public class EmailClient extends Frame {
    ...
    private Button btSet = new Button("Use Default Address");
    ...
    public EmailClient() {
	   ...
	   create an extra panel for holding all the child panels. */
        ...
        fromPanel.add(btSet, BorderLayout.EAST);
        ...
        btSet.addActionListener(new SetListener());
    ...
    class SetListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                fromField.setText(System.getProperty("user.name") + "@" + localhost);
