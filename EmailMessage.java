...
public class EmailMessage {
    ...
    public EmailMessage(String from, String to, String cc, String subject, String text,
        ...
        Sender = from.trim();
        Recipient = to.trim();
        otherRecipient = cc.trim();

        Headers = "From: " + Sender + CRLF;
        Headers += "To: " + Recipient + CRLF;
        Headers += "CC: " + otherRecipient + CRLF;
        ...
        try {
            myLocalhost = InetAddress.getLocalHost().getHostName();
    ...
    public boolean isValid() {
        ...
        int toat = Recipient.lastIndexOf('@');
